...
# def vad(signal, sr, nFFT=512, win_length=0.025, hop_length=0.01, theshold=0.99):
def vad(signal, sr, nFFT=64, win_length=0.02, hop_length=0.03, theshold=0.99):
